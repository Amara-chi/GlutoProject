      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-2/3">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {cartItems.map((item) => (
                  <div key={item._id} className="p-4 sm:p-6 flex flex-col xs:flex-row items-start xs:items-center gap-4 sm:gap-6">
                    <img
                      src={item.image}
                      alt={item.name}
                    ...
                    <div className="w-full xs:w-auto flex justify-between items-center gap-4">
          ...
          <div className="lg:w-1/3">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 sm:p-6 sticky top-6">
              ...
              <button
                ...
                className="w-full mt-4 sm:mt-6 bg-primary-600 text-white py-2 sm:py-3 rounded-lg font-semibold hover:bg-primary-700 transition-colors duration-200 text-sm sm:text-base"
              >
                Place Order
              </button>
            </div>
